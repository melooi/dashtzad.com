...
function Ph({ icon: Icon, caption }: { icon: typeof Sprout; caption: string }) {
  return (
    <div className="ph">
        ...
        <div className="wrap about-hero__inner">
          ...
          <div className="about-hero__stats">
            <span className="ab-stat">
              <Sprout aria-hidden /> ریشه از <b>۱۳۰۵</b>
            </span>
            <span className="ab-stat">
              <Handshake aria-hidden /> بدون واسطه
            </span>
            <span className="ab-stat">
              <MountainSnow aria-hidden /> مستقیم از باغ‌های دماوند
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="about-story">
            <div className="about-story__body">
              ...
              <p>
                نامِ دشت‌زاد از یاد مردی آمده که ریشه‌اش در خاک بود و زندگی‌اش با کار، قناعت و تلاش معنا
                پیدا می‌کرد. <strong>علی‌اکبر جلوداری، زادهٔ سال ۱۳۰۵</strong>، از نسلی بود که زمین را
                می‌شناخت، قدرِ دانه را می‌دانست و می‌فهمید پشتِ هر محصول، زحمتِ یک خانواده و امیدِ یک
                فصل نشسته است.
              </p>
              <p>
                دشت‌زاد ادامهٔ همان نگاه است؛ نگاهی که به محصول فقط به چشمِ کالا نگاه نمی‌کند، بلکه آن
                را بخشی از زندگی مردم، سفرهٔ خانه‌ها و خاطرهٔ خانواده‌ها می‌داند.
              </p>
            ...
            <div className="about-story__media">
              <div className="about-story__frame">
                <Ph icon={Sprout} caption="عکس قدیمیِ خانوادگی — علی‌اکبر جلوداری / باغ خانوادگی" />
              </div>
        ...
        <div className="wrap">
          <div className="meaning__head">
            <span className="meaning__kicker">
              <Quote aria-hidden /> دشت‌زاد یعنی چه؟
            </span>
            <h2 className="meaning__title">
              یعنی <span className="honey">زادهٔ دشت</span> — هر دانه، بخشی از یک زندگی‌ست
            </h2>
            <p className="meaning__sub">
              ما باور داریم هر مشت حبوبات، هر دانه برنج و هر بسته خشکبار که به خانهٔ شما می‌رسد، فقط یک
              خرید ساده نیست؛ بخشی از آشپزی روزانه، مهمانی‌ها، دورهمی‌ها و خاطره‌های خانوادگی‌ست.
            </p>
          </div>
        ...
        <div className="wrap">
          ...
          <div className="contrast-grid">
            <div className="cpanel cpanel--dull">
              ...
              <div className="clist">
                <div className="cli">
                  <X aria-hidden /> نمی‌دانی محصول از کجا آمده و چطور نگهداری شده.
                </div>
                <div className="cli">
                  <X aria-hidden /> اطلاعاتِ مبهم؛ معلوم نیست همان چیزی را می‌گیری که سفارش دادی.
                </div>
                <div className="cli">
                  <X aria-hidden /> بین ده‌ها محصولِ شبیه به هم، گیج می‌شوی.
                </div>
                <div className="cli">
                  <X aria-hidden /> بعد از فروش، دیگر کسی پاسخ‌گو نیست.
                </div>
              </div>
            </div>
            ...
            <div className="cpanel cpanel--us">
              ...
              <div className="clist">
                <div className="cli">
                  <Check aria-hidden /> ریشه و داستانِ محصول روشن است — مستقیم از باغ، بدون واسطه.
                </div>
                <div className="cli">
                  <Check aria-hidden /> اطلاعاتِ شفاف برای انتخابِ بهتر، پیش از خرید.
                </div>
                <div className="cli">
                  <Check aria-hidden /> انتخابِ دقیق و بسته‌بندیِ تمیز و قابل اعتماد.
                </div>
                <div className="cli">
                  <Check aria-hidden /> پیگیریِ سفارش و پاسخ‌گوییِ واقعی، بعد از خرید.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="values-grid">
            ...
            <article className="value">
              ...
              <p className="value__d">خریدِ آنلاینِ مواد غذایی باید ساده، قابل فهم و بی‌دردسر باشد.</p>
            </article>
          </div>
        </div>
      </section>
            ...
            <aside className="promise__card">
              ...
              <div className="promise__cta">
                <Link className="btn btn--primary btn--lg" href="/products">
                  <Store aria-hidden /> دیدنِ محصولاتِ دشت‌زاد
                </Link>
              </div>
              <div className="promise__sign">
                <Sprout aria-hidden /> دشت‌زاد؛ روایتِ یک نسل از ۱۳۰۵.
              </div>
            </aside>
          </div>
        </div>
